...
export default function LeaderboardPage() {
  const topStudents = [
    { rank: 1, name: 'Sarah Chen', xp: 12450, avatar: 'S', color: '#f9ca24', badge: 'Diamond' },
    { rank: 2, name: 'David Kim', xp: 11200, avatar: 'D', color: '#dcdde1', badge: 'Platinum' },
    { rank: 3, name: 'Priya Patel', xp: 10850, avatar: 'P', color: '#e1b12c', badge: 'Gold' },
  ];

  const rankings = [
    { rank: 4, name: 'Alex Miller', xp: 9500, avatar: 'A' },
    { rank: 5, name: 'Marcus Johnson', xp: 9100, avatar: 'M' },
    { rank: 6, name: 'Jessica Wong', xp: 8850, avatar: 'J' },
    { rank: 7, name: 'Thomas Wright', xp: 8200, avatar: 'T' },
    { rank: 8, name: 'Elena Rodriguez', xp: 7900, avatar: 'E' },
  ];
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'flex-end', gap: '16px', marginBottom: '40px', height: '260px' }}>
          ...
          <div style={{ width: '30%', background: 'white', borderRadius: '16px 16px 0 0', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '24px', borderTop: `4px solid ${topStudents[1].color}`, height: '80%', position: 'relative', boxShadow: '0 -10px 30px rgba(0,0,0,0.05)' }}>
            ...
            <p style={{ color: '#8892b0', margin: '4px 0 16px 0', fontSize: '0.9rem' }}>{topStudents[1].xp} XP</p>
          ...
          <div style={{ width: '35%', background: 'white', borderRadius: '16px 16px 0 0', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '24px', borderTop: `4px solid ${topStudents[0].color}`, height: '100%', position: 'relative', boxShadow: '0 -10px 40px rgba(108,92,231,0.1)', zIndex: 10 }}>
            ...
            <p style={{ color: '#8892b0', margin: '4px 0 16px 0', fontSize: '0.9rem', fontWeight: 600 }}>{topStudents[0].xp} XP</p>
          ...
          <div style={{ width: '30%', background: 'white', borderRadius: '16px 16px 0 0', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '24px', borderTop: `4px solid ${topStudents[2].color}`, height: '70%', position: 'relative', boxShadow: '0 -10px 30px rgba(0,0,0,0.05)' }}>
            ...
            <p style={{ color: '#8892b0', margin: '4px 0 16px 0', fontSize: '0.9rem' }}>{topStudents[2].xp} XP</p>
        ...
        <div style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', border: '1px solid rgba(108,92,231,0.08)' }}>
          {rankings.map((student, index) => (
            <div key={student.rank} style={{ display: 'flex', alignItems: 'center', padding: '16px 24px', borderBottom: index === rankings.length - 1 ? 'none' : '1px solid rgba(108,92,231,0.04)', transition: 'background 0.2s' }} onMouseEnter={(e) => e.currentTarget.style.background = 'rgba(108,92,231,0.02)'} onMouseLeave={(e) => e.currentTarget.style.background = 'white'}>
              ...
              <div style={{ flex: 1, fontWeight: 600, color: '#1a1a2e' }}>{student.name}</div>
              <div style={{ fontWeight: 700, color: '#6c5ce7' }}>{student.xp} XP</div>
            </div>
          ))}
        </div>
      ...
      <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, background: 'rgba(17,17,38,0.95)', backdropFilter: 'blur(10px)', padding: '20px', borderTop: '1px solid rgba(255,255,255,0.1)', zIndex: 100 }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
            <div style={{ width: '50px', height: '50px', borderRadius: '50%', background: '#6c5ce7', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', fontSize: '1.25rem', border: '2px solid rgba(255,255,255,0.2)' }}>P</div>
            <div>
              ...
              <div style={{ fontSize: '1.25rem', color: 'white', fontWeight: 800 }}>#42 <span style={{ fontSize: '0.9rem', color: '#a0aec0', fontWeight: 500, marginLeft: '8px' }}>Phaneendra</span></div>
            </div>
          </div>
          <div style={{ textAlign: 'right' }}>
            <div style={{ fontSize: '1.25rem', color: 'white', fontWeight: 800, marginBottom: '4px' }}>2,450 XP</div>
            <div style={{ fontSize: '0.85rem', color: '#a0aec0' }}>50 XP needed to pass #41</div>
          </div>
        </div>
      </div>
